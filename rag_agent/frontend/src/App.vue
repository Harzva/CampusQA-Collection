<template>
  ...
  <header class="app-header">
    ...
    <!-- Mode selector: choose between RAG and Agent modes -->
...
async function sendQuestion() {
  ...
  try {
    ...
    loading.value = true;
    // Determine the endpoint based on the selected mode
    const endpoint = selectedMode.value === 'agent' ? '/api/agent/chat' : '/api/chat';
